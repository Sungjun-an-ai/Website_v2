...
const emptySection: Omit<AboutSection, 'id'> = {
  section_key: '', title_ko: '', title_en: '', content_ko: '', content_en: '', image_url: '', order_index: 0
}
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-3 py-2">
              {([['section_key','섹션 키 (예: overview)'],['title_ko','제목 (한)'],['title_en','제목 (영)'],['image_url','배경 이미지 URL']] as [keyof typeof form, string][]).map(([key, label]) => (
